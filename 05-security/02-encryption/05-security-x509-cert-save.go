/*
  ...
  PKI: Public Key Infrastructure for a collection of public keys + owner name/location/etc information

  provides an approval mechanism

  x.509 certificates are the principal PKI in use today (for example, web sites use them to verify identities)

  Below is a self-signed cert (saved as a .cer file)
*/
